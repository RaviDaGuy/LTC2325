...
HD_PWD='C:/Users/Ravi/sidplayLedSDR/sidplayLedSDR.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log receiveData.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source receiveData.tcl -notrace
