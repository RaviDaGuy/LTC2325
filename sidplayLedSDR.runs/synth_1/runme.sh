...
HD_PWD='C:/Users/Ravi/sidplayLedSDR/sidplayLedSDR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log receiveData.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source receiveData.tcl
